...
elseif database:sismember(bot_id..'Special:User'..chat_id, user_id) then  
var = database:get(bot_id.."Special:Rd"..msg.chat_id_) or 'ممي🥉ز'  
else  
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/BESSOBOT/Files_Besso/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n📁| اهلا بك في متجر ملفات BESSO\n🔰| ملفات السورس ↓\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n\n"
local TextE = "\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n🔘|  علامة تعني { ✓ } ملف مفعل\n🔘| علامة تعني { ✘ } ملف معطل\n🔖| قناة سورس BESSO ↓\n".."📮| [اضغط هنا لدخول](t.me/BESSO500K) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/BESSOBOT/Files_Besso/master/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('BESSO.lua')  
else
send(msg.chat_id_, msg.id_,"⚠️| عذرا هاذا ملف ليس من ملفات سورس BESSO\n") 
end
return false
end
...
send(msg.chat_id_, msg.id_,"⚠️|اذا ملف ليس من ملفات سورس BESSO\n") 
end
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n👤¦ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n🦓¦ تم ترقيه ابو المطايه شوفناا مهاراتكك يمطي '
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n👤¦ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
status  = '\n🦓¦ تم تنزيل المطي حتى لا يزگط الاخرين'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if text and (text:match('^mutetime (%d+)$') or text:match('^تقييد (%d+)$')) then
local times = text:match('^mutetime (%d+)$') or text:match('^تقييد (%d+)$')
time = times * 60
local function Restricted(Kara,Besso)
if tonumber(Besso.sender_user_id_) == tonumber(bot_id) then
send(msg.chat_id_, msg.id_, '\n⚠¦ عذرا لا تستطيع تقييد ( '..Rutba(Besso.sender_user_id_,msg.chat_id_)..' )')
return false  
end
if Can_or_NotCan(Besso.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n⚠¦ عذرا لا تستطيع تقييد ( '..Rutba(Besso.sender_user_id_,msg.chat_id_)..' )')
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n👤¦ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
status  = '\n🐃¦ تم تنزيل الصخل لكي لا ينطح الكروب' 
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n👤¦ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n🐺¦ تم رفع الجلب المجلوب لا تعض البقيه '
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n👤¦ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
status  = '\n🐺¦ تم تنزيل جلب المجلوب صدكك مجلوب عض العضاء كلهاا'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n👤¦ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n🐒¦ تم رفع المدعو قررود ونسنه ضايجين كوم اركصا '
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n👤¦ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
status  = '\n🐒¦ تم تنزيل القرد لان مايعرف يركص وحتى يجفص بلحجي'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
-----------------------------------------------------
if text == 'مسح الحصونه' and Mod(msg) then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n👤¦ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n🐎¦ تم رفع حصاان جديد بلكروك يولد لحد يتقبله ترا يزكط '
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n👤¦ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
status  = '\n🐎¦ تم تنزيل الحصان لان ضرب تلاثه بلكروب وتخربطو وهسا بلعنايه المركزه'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n👤¦ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n🐏¦ تم رفع طلي ممكن لو سمحتو هناا حشيش '
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n👤¦ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
status  = '\n🐏¦ تم تنزيل طلي مابيه كل فايده بس مال ءكل'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n👤¦ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n🦎¦ تم رفع زاحف بشرفك لو اختك تقب واحد يزحفلهاا ها ها جاوبني زاحف '
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n👤¦ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
status  = '\n🦎¦ تم تنزيل زاحف صار حباب وبطل زجف تعلمو مثله'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n👤¦ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n🐀¦ تم رفع جريذي جديد وصخ ابو ريحه ماتسبح ونتا جريذي '
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n👤¦ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
status  = '\n🐀¦ تم الجريذي تنزيل الوصخ يله روح اسبح'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
🚷╣ كتم←الغاء كتم
🔕╣ تقيد←الغاء تقيد
🔕╣ تقييد←بالدقايق ←الغاء تقيد
🔕╣ سكوت←بالدقايق ←الغاء تقيد
🚯╣ طرد
📑╣ تثبيت←الغاء تثبيت
🚸╣ ضع تكرار + العدد
📛╣ الترحيب
...
~~~~~~~~~~~~~~~~~~~
🏅╗  المنشئين←العرض←المنشئين
🥇╣ المدراء  ←العرض← المدراء
🥈╣ الادمنيه ←العرض← الادمنيه
🥉╣ المميزين←العرض ← المميزين
🔕╣ المحظورين←العرض الحظورين
🔐╣ المكتومين←العرض المكتومين
🦓╣ المطايه  ←العرض ← المطايه
🐃╣ الصخوله←العرض ← الصخوله
🐺╣ الجلاب  ←العرض ← الجلاب
🐒╣ القروده  ←العرض ← القروده
🐎╣ الحصونه←العرض ← الحصونه
🐮╣ البقر  ←العرض ← البقر
🐏╣ الطليان ←العرض ← الطليان
🦎╣ الزواحف←العرض ← الزواحف
🐀╣  الجريذيه←العرض ← الجريذيه
⚙╣  كشف←بالرد ← بالمعرف
🏅╝ المنشئ←العرض ← المالك
~~~~~~~~~~~~~~~~~~~
🔖╗ رفع القيود
